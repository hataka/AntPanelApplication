...
namespace AntPlugin.CommonLibrary
{
  ...
  public partial class GradleTree : UserControl
  {
    ...
    public static String targetpublic_iconPath = Path.Combine(PathHelper.BaseDir, @"SettingData\targetpublic_obj.png");
    public static String defaulttarget_iconPath = Path.Combine(PathHelper.BaseDir, @"SettingData\defaulttarget_obj.png");
    public static String targetinternal_iconPath = Path.Combine(PathHelper.BaseDir, @"SettingData\targetinternal_obj.png");
    ...
    public static String GetXmlStringGradleAllTasks(String file)
    {
      ...
      String iconPath = Path.Combine(PathHelper.BaseDir, @"SettingData\targetpublic_obj.png");
