...
namespace AntPanelApplication.Utilities
{
	public class ArgsProcessor
	{
      ...
      if (((RichTextEditor)Globals.MainForm.CurrentDocument).richTextBox1.SelectionLength > 0)
      {
        return ((RichTextEditor)Globals.MainForm.CurrentDocument).richTextBox1.SelectedText;
      }
      ...
      return Globals.MainForm.CurrentDocumentPath;
    }
		...
		{
      //if (!Globals.MainForm.IsEditable) return Globals.MainForm.WorkingDirectory;
      //else return Path.GetDirectoryName(GetCurFile());
      return Path.GetDirectoryName(Globals.MainForm.CurrentDocumentPath);
    }
    ...
    public static String GetCurFilename()
      ...
      return Path.GetFileName(Globals.MainForm.CurrentDocumentPath);
    }
    ...
    public static String GetCurFilenameNoExt()
      ...
      return Path.GetFileNameWithoutExtension(Globals.MainForm.CurrentDocumentPath);
    }
