...
namespace AntPlugin.XMLTreeMenu.Controls
{
  public partial class RichTextEditor : UserControl
	...
	public List<string> PreviousDocuments
	{
      ...
      this.richTextBox1.ContextMenuStrip = Globals.MainForm.EditorMenu;
	...
	/// <param name="linkage">もう片方のパネル</param>
	  ...
	  private void RichTextEditor_Load(object sender, EventArgs e)
	  {
	    ...
	    {
		    array = ((string)this.richTextBox1.Tag).Split('!');
	   ...
	   if (array != null && array.Length > 1)
	    {
		    ...
		    switch (this.Parent.GetType().Name)
		    {
		      case "DockContent":
			      ...
			      break;
		      case "Form":
			      try { ((Control)this.Parent).Text = "[出力]" + Path.GetFileName(array[0]); } catch { }
			      break;
		      case "PabPage":
    ...
    private void richTextBox1_MouseDown(object sender, MouseEventArgs e)
    {
      if (e.Button == MouseButtons.Right)
      {
        ...
        int positionToSearch = this.richTextBox1.GetCharIndexFromPosition(new Point(e.X, e.Y));
        this.richTextBox1.SelectionStart = positionToSearch;
      }
    }
	...
	Point GetCurrentPosition()
	{
	  ...
	  public void 開くOToolStripMenuItem_Click(object sender, EventArgs e)
	  {
	    ...
	    try
	    {
		    ...
		    */
		    this.richTextBox1.Tag = this.currentPath;
		    ((Control)base.Parent).Text = Path.GetFileName(text);
	  ...
	  private void 名前を付けて保存AToolStripMenuItem_Click(object sender, EventArgs e)
	  {
	    ...
	    if (toolStripMenuItem.Name == "sHIFTJISで保存ToolStripMenuItem") text = "SHIFT_JIS";
	    else if (toolStripMenuItem.Name == "uTF8で保存ToolStripMenuItem")text = "UTF-8";
  	  else if (toolStripMenuItem.Name == "名前を付けて保存AToolStripMenuItem") text = "UTF-8";
  	  else text = "UTF-8";
	    string filter = "Textファイル(*.txt)|*.txt|c,cs関連ファイル(*.c;*.cs;.c*.cpp;*,h)|*.c;*.cs;*.cpp;*.h|HTMLファイル(*.html;*.htm)|*.html;*.htm|すべてのファイル(*.*)|*.*";
	    string[] array = ((string)this.richTextBox1.Tag).Split('!');
	    ...
	    {
		    if (File.Exists(array[0]))  initialDirectory = Path.GetDirectoryName(array[0]);
    		else initialDirectory = @"F:\";
		    fileName = "新しいファイル.txt";
	    }
	    else
	    {
		    try
		    {
		      ...
		      if (text == string.Empty)	text = "UTF-8";
		    }
		    catch (Exception ex)
		    {
		      string message = ex.Message.ToString();
    ...
    private void pd_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
      ...
      Globals.MainForm.OpenCustomDocument("AzukiEditor",this.currentPath);
    }
    ...
    private void エクスプローラEToolStripMenuItem_Click(object sender, EventArgs e)
	  ...
	  private void microsoftWordで開くWToolStripMenuItem_Click(object sender, EventArgs e)
	  {
        ...
        Process.Start(@"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\LibreOffice 6.1\LibreOffice", this.currentPath);
      }
	  }

	  private void ファイル名を指定して実行OToolStripMenuItem_Click(object sender, EventArgs e)
	  {
      ActionManager.RunProcessDialog(sender,e);
      //PluginBase.MainForm.CallCommand("PluginCommand", "XMLTreeMenu.RunProcessDialog");
    }

	  private void フォントと色Button_Click(object sender, EventArgs e)
	  {
	  ...
	  private void 太字Button_Click(object sender, EventArgs e)
	  {
	    try
	    {
	  ...
	  private void イタリック体Button_Click(object sender, EventArgs e)
	  {
	  ...
	  private void アンダーラインButton_Click(object sender, EventArgs e)
	  {
	  ...
	  private void 文字色Button_Click(object sender, EventArgs e)
	  {
	    ColorDialog colorDialog = new ColorDialog();
	    colorDialog.CustomColors = new int[]
			{
				51,	102,153,204,13056,13107,13158,13209,13260,26112,26163,26214,26265,26316,39168,39219
			};
	  ...
	  private void 背景色Button_Click(object sender, EventArgs e)
	  {
	    ColorDialog colorDialog = new ColorDialog();
	    colorDialog.CustomColors = new int[]
			{
	  ...
	  private void 左寄せButton_Click(object sender, EventArgs e)
	  {
	    this.richTextBox1.SelectionAlignment = HorizontalAlignment.Left;
	    this.toolStripButton8.CheckState = CheckState.Checked;
	  }

	  private void 中央揃えButton_Click(object sender, EventArgs e)
	  {
	    this.richTextBox1.SelectionAlignment = HorizontalAlignment.Center;
	    this.toolStripButton9.CheckState = CheckState.Checked;
	  }

	  private void 右寄せButton_Click(object sender, EventArgs e)
	  {
	    this.richTextBox1.SelectionAlignment = HorizontalAlignment.Right;
	    this.toolStripButton10.CheckState = CheckState.Checked;
	  }

	  private void 均等割り付けButton_Click(object sender, EventArgs e)
	  {

	  }

	  private void 番号付リストButton_Click(object sender, EventArgs e)
	  {
	  ...
	  private void 番号なしリストButton_Click(object sender, EventArgs e)
	  {
	    this.richTextBox1.SelectionBullet = true;
	  }

	  private void アウトデントButton_Click(object sender, EventArgs e)
	  {
	    this.richTextBox1.Clear();
	  ...
	  private void インデントButton_Click(object sender, EventArgs e)
	  {

	  }

	  private void 図形を挿入Button_Click(object sender, EventArgs e)
	  {
	    Image image = null;
	    string text = Lib.File_OpenDialog("menu.xml", BaseDir, "TreeDataファイル(*.xml)|*.xml|すべてのファイル(*.*)|*.*");
	    if (File.Exists(text))
	    {
		    try
		    {
	  ...
	  private void queryString試験MenuItem_Click(object sender, EventArgs e)
	  {
    ...
    static string hideText;
    static int selectionStart;
    static int selectionLength;
    private void test1ToolStripMenuItem_Click(object sender, EventArgs e)
    {
      //ToolStripMenuItem item = sender as ToolStripMenuItem;
      //MessageBox.Show("こんにちわ! " + item.Name + " です");

      hideText = richTextBox1.SelectedText;// "test2 ";
      ...
      /*
      // https://stackoverflow.com/questions/16414326/hide-some-part-of-text-in-the-richtextbox-in-vb-net
      ...
      */
      /*
      // https://www.pcreview.co.uk/threads/re-adding-hidden-text-to-a-rich-text-box-control.1348949/
      ...
      MessageBox.Show("TextichTextBox1.Text);
      MessageBox.Show("RTFichTextBox1.Rtf);
      */
    }
    ...
    private void test2ToolStripMenuItem_Click(object sender, EventArgs e)
    {
      ...
      richTextBox1.SelectedText = hideText;
    }
    #endregion
    ...
    public void PopulatePreviousDocumentsMenu()
	  {
	    try
	    {
		    ...
		    for (int i = 0; i < this.previousDocuments.Count; i++)
		    {
		      ...
		      if (string.IsNullOrEmpty(text2))  text2 = "TextLog";
		      if (array.Length > 1)
		      {
			      if (!text2.StartsWith("[出力]")) toolStripMenuItem2.Text = "[出力]" + text2;
			      else toolStripMenuItem2.Text = text2;
		      }
		      if (array.Length == 1) toolStripMenuItem2.Text = text;
		      if (i < 15) toolStripMenuItem.DropDownItems.Add(toolStripMenuItem2);
		      else this.previousDocuments.Remove(text);
		    }
    ...
    private void 最近開いたファイルをクリアCToolStripMenuItem_Click(object sender, EventArgs e)
      ...
      this.タイムスタンプToolStripMenuItem.Size = new System.Drawing.Size(216, 26);
      ...
      this.c見出しToolStripMenuItem.Size = new System.Drawing.Size(216, 26);
      ...
      this.右端で折り返すToolStripMenuItem.Size = new System.Drawing.Size(216, 26);
      ...
      this.フォントと色ToolStripMenuItem.Size = new System.Drawing.Size(216, 26);
      ...
      this.カスタマイズCToolStripMenuItem.Size = new System.Drawing.Size(216, 26);
      ...
      this.toolStripMenuItem2.Click += new System.EventHandler(this.queryString試験MenuItem_Click);
      // 
      ...
      this.オプションOToolStripMenuItem.Size = new System.Drawing.Size(216, 26);
      ...
      this.toolStripButton2.Click += new System.EventHandler(this.フォントと色Button_Click);
      // 
      // toolStripButton3
      // 
      ...
      this.toolStripButton3.Click += new System.EventHandler(this.太字Button_Click);
      // 
      // toolStripButton4
      // 
      ...
      this.toolStripButton4.Click += new System.EventHandler(this.イタリック体Button_Click);
      // 
      // toolStripButton5
      // 
      ...
      this.toolStripButton5.Click += new System.EventHandler(this.アンダーラインButton_Click);
      // 
      // toolStripButton6
      // 
      ...
      this.toolStripButton6.Click += new System.EventHandler(this.文字色Button_Click);
      // 
      // toolStripButton7
      // 
      ...
      this.toolStripButton7.Click += new System.EventHandler(this.背景色Button_Click);
      // 
      // toolStripButton8
      // 
      ...
      this.toolStripButton8.Click += new System.EventHandler(this.左寄せButton_Click);
      // 
      // toolStripButton9
      // 
      ...
      this.toolStripButton9.Click += new System.EventHandler(this.中央揃えButton_Click);
      // 
      // toolStripButton10
      // 
      ...
      this.toolStripButton10.Click += new System.EventHandler(this.右寄せButton_Click);
      // 
      // toolStripButton11
      // 
      ...
      this.toolStripButton11.Click += new System.EventHandler(this.均等割り付けButton_Click);
      // 
      // toolStripButton12
      // 
      ...
      this.toolStripButton12.Click += new System.EventHandler(this.番号付リストButton_Click);
      // 
      // toolStripButton13
      // 
      ...
      this.toolStripButton13.Click += new System.EventHandler(this.番号なしリストButton_Click);
      // 
      // toolStripButton14
      // 
      ...
      this.toolStripButton14.Click += new System.EventHandler(this.アウトデントButton_Click);
      // 
      // toolStripButton15
      // 
      ...
      this.toolStripButton15.Click += new System.EventHandler(this.インデントButton_Click);
      // 
      // toolStripButton16
      // 
      ...
      this.toolStripButton16.Click += new System.EventHandler(this.図形を挿入Button_Click);
      // 
      // imageListButton
      // 
      ...
      this.richTextBox1.Size = new System.Drawing.Size(905, 379);
      ...
      this.splitContainer1.Size = new System.Drawing.Size(993, 379);
      ...
      this.richTextBox2.Size = new System.Drawing.Size(84, 379);
