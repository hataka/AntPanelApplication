...
using System.IO;
using CommonInterface.Controls;
...
namespace AntPanelApplication.Controls
{
	public class Browser : UserControl
	{
		...
		private CommonLibrary.ToolStripSpringComboBox2 addressComboBox;
      ...
      this.Font = new Font("Meiryo UI", 12.0F, FontStyle.Regular, GraphicsUnit.Point, ((byte)(0)));
		...
		private void InitializeComponent()
		{
			...
			this.addressComboBox = new CommonLibrary.ToolStripSpringComboBox2();
	...
	/// </summary>
		public CommonLibrary.ToolStripSpringComboBox2 AddressBox
		...
		{
		  //this.addressComboBox.FlatStyle - FlatStyle.Flat;//= Globals.Settings.ComboBoxFlatStyle;
