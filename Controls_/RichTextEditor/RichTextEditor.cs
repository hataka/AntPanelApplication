    ...
    */
    ...
    private void UpdateStatusText(string data)
    {
      ...
      //string format = " 行: {0} | 列: {1} | 改行コード: ({2}) | 文字コード: {3} | {4}";
        string format = " 行: {0} | 列: {1} | 改行コード: ({2}) | 文字コード: {3} | {4} | {5}";
      ...
      try { text5 = this.richTextBox1.Text[this.richTextBox1.SelectionStart].ToString(); }catch { }
      //this.toolStripStatusLabel1.Text = string.Format(format, new object[] { x, y, text2, text3, text });
      this.toolStripStatusLabel1.Text = string.Format(format, new object[] { x, y, text2, text3, text,text5 });
    }
    #endregion
    ...
    private void InitializeComponent()
    {
      ...
      this.test1ToolStripMenuItem.Size = new System.Drawing.Size(123, 26);
      ...
      this.test2ToolStripMenuItem.Size = new System.Drawing.Size(123, 26);
