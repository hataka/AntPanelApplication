...
namespace AntPlugin.Controls
{
  public partial class XmlTreePanel : UserControl
  {
    ...
    public XmlTreePanel(PluginUI ui)
    {
      this.pluginUI = ui;
  ...
  private void InitializeInterface()
    {
      ...
      this.mainForm.imageList1 = this.pluginUI.imageList;
      this.mainForm.imageList2 = AntPlugin.PluginUI.imageList2;
    ...
    private void CreateMenus()
    {
      ...
      buildFileMenu.Items.Add("Run default target", this.pluginUI.runButton.Image, this.MenuRunClick);
      buildFileMenu.Items.Add("Edit file", null, this.MenuEditClick);
      buildFileMenu.Items.Add(new ToolStripSeparator());
      buildFileMenu.Items.Add("Remove",PluginBase.MainForm.FindImage("153"), this.MenuRemoveClick);
      buildFileMenu.Tag = this.treeView1;

      targetMenu = new ContextMenuStrip();
      targetMenu.Items.Add("Run target", this.pluginUI.runButton.Image, this.MenuRunClick);
    ...
    private void InitializeTreeView()
    {
      ...
      this.treeView1.ImageList = this.pluginUI.imageList;
    ...
    public void MenuRunClick(object sender, EventArgs e)
    {
      ...
      if (node == null)
        return;
      this.pluginMain.RunTarget(node.File, node.Target);
     }
    ...
    public void MenuRemoveClick(object sender, EventArgs e)
    {
      if (treeView1.SelectedNode.GetType().Name == "AntTreeNode")
      {
        this.pluginMain.RemoveBuildFile(
