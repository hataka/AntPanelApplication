  ...
  public class FTPClientPanel : UserControl
  {
    ...
    */
    ...
    private void InitializeSettings()
    {
      ...
      this.toolStrip1.Font = this.settings.DefaultFont;
      this.lviFolder.Font = this.settings.DefaultFont;
    }
    ...
    private void FTPConnect()
    {
      ...
      {
        Globals.MainForm.StatusLabel.Text = "接続失敗";;
        this.FtpClient.Close();
        this.FtpClient = null;
        return;
      }
      Globals.MainForm.StatusLabel.Text = "接続成功";
    ...
    public void disconnectButton_Click(object sender, EventArgs e)
    {
      ...
      Globals.MainForm.StatusLabel.Text = "切断";
     }
    ...
    private void downLoadButton_Click(object sender, EventArgs e)
    {
      ...
      if (listViewItem is FTPClientPanel.FileItem)
      {
        ...
        if (dialogResult == DialogResult.OK)
        {
          ...
          //MessageBox.Show(this.currentDownLoadedFile);
          //TODO: ファイルを開く処理
          if (dialogResult2 == DialogResult.Yes)
          {
            Globals.MainForm.OpenDocument(this.currentDownLoadedFile);
          }
        }
      }
    }
    ...
    private void ヘルプLToolStripButton_Click(object sender, EventArgs e)
    {
      ...
      Globals.MainForm.OpenCustomDocument("BrowserEx",str);
    }
    ...
    private void コマンドプロンプトCToolStripMenuItem_Click(object sender, EventArgs e)
    {
      ...
      else if (listViewItem is FTPClientPanel.FileItem)
      {
        ...
        if (result == DialogResult.Yes)
        {
          //PluginBase.MainForm.CallCommand("PluginCommand", "XMLTreeMenu.BrowserEx;" + url);
        }
      */
      }
    }
    ...
    private void 編集ToolStripMenuItem_Click(object sender, EventArgs e)
    {
      if (MainForm.IsRunningWindows)
      {
        Globals.MainForm.OpenDocument(System.IO.Path.Combine(PathHelper.SettingDataDir, "server.xml"));
      }
      else if (MainForm.IsRunningUnix)
      {
        Globals.MainForm.OpenDocument(System.IO.Path.Combine(PathHelper.BaseDir, "SettingData/server.xml"));
      }
    }
    ...
    private void 同期フォルダーへToolStripMenuItem_Click(object sender, EventArgs e)
    {
      ...
      if (listViewItem is FTPClientPanel.FileItem)
      {
        ...
        if (dialogResult2 == DialogResult.Yes)
        {
          Globals.MainForm.OpenDocument(this.GetSelectedDocumentPath());
        }
      }
    }
