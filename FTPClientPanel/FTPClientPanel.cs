...
namespace AntPlugin.Controls
{
  public class FTPClientPanel : UserControl
  {
    ...
    public FTPClientPanel(PluginUI ui)
    {
      this.pluginUI = ui;
      this.pluginMain = ui.pluginMain;
      //this.settings = ((Settings)pluginMain.Settings);
      this.settings = ((Settings)ui.pluginMain.Settings);
      this.InitializeComponent();
      this.InitializeFTPClient();
    }
    #endregion
    ...
    private void InitializeFTPClient()
    {
      ...
      this.loadServerXML(System.IO.Path.Combine(PathHelper.BaseDir, @"SettingData\server.xml"));
    ...
    private void FTPConnect()
    {
      ...
      {
        PluginBase.MainForm.StatusLabel.Text = "接続失敗";
        this.FtpClient.Close();
        this.FtpClient = null;
        return;
      }
      PluginBase.MainForm.StatusLabel.Text = "接続成功";
    ...
    public void disconnectButton_Click(object sender, EventArgs e)
    {
      ...
      PluginBase.MainForm.StatusLabel.Text = "切断";
    }
    ...
    private void downLoadButton_Click(object sender, EventArgs e)
    {
      ...
      if (listViewItem is FTPClientPanel.FileItem)
      {
        ...
        if (dialogResult == DialogResult.OK)
        {
          ...
          {
            PluginBase.MainForm.OpenEditableDocument(this.currentDownLoadedFile);
          }
        }
      }
    }
    ...
    private void ヘルプLToolStripButton_Click(object sender, EventArgs e)
    {
      ...
      //PluginBase.MainForm.CallCommand("PluginCommand", "XMLTreeMenu.BrowseEx;" + str);
    ...
    private void 同期フォルダーへToolStripMenuItem_Click(object sender, EventArgs e)
    {
      ...
      if (listViewItem is FTPClientPanel.FileItem)
      {
        ...
        if (dialogResult2 == DialogResult.Yes)
        {
          PluginBase.MainForm.OpenEditableDocument(this.GetSelectedDocumentPath());
        }
      }
    }
    ...
    private void nextFTPToolStripMenuItem_Click_1(object sender, EventArgs e)
    {
     ...
     Process.Start(this.pluginUI.settings.NextFTPPath, connectionKey);
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.niftyToolStripMenuItem.Size = new System.Drawing.Size(154, 26);
      ...
      this.lacoocanToolStripMenuItem.Size = new System.Drawing.Size(154, 26);
      ...
      this.nexrFTPToolStripMenuItem.Size = new System.Drawing.Size(154, 26);
      ...
      this.オプションToolStripMenuItem.Size = new System.Drawing.Size(163, 26);
