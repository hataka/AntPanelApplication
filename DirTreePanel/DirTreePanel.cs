...
namespace AntPanelApplication
{
  public class DirTreePanel : UserControl
  {
    ...
    public DirTreePanel(AntPanel ui)
    {
      this.antPanel = ui;
      this.InitializeComponent();
      this.currentProjectDir = AntPanel.projectDir;
    ...
    private void InitializeComponent()
    {
      ...
      this.itemFolderButton.Enabled = false;
    ...
    public void InitializDirTreeView()
    {
      ...
      if ( !String.IsNullOrEmpty(AntPanel.projectDir))
      {
        this.currentProjectDir = AntPanel.projectDir;
      }
      Boolean projectExists = (this.currentProjectDir != null);
      ...
      if (this.dirTreeView1 == null)
      {
        if (projectExists)
        {
          this.dirTreeView1 = new DirTreeView(this.currentProjectDir);
        }
        else
        {
    ...
    private void dirTreeView1_richTextEditorToolStripMenuItem1_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        //this.OpenDocument(path);
        String txt = Lib.File_ReadToEndDecode(path);
        
        
        // FIXME !!
        //antPanel.PluginBase.MainForm.CallCommand("PluginCommand",
    ...
    private void moveButton_Click(object sender, EventArgs e)
    {
      ...
      if(item == "synchronizeButton")
      {
        if (AntPanel.IsRunningWindows) Process.Start("explorer.exe", this.currentRootDir);
        else if (AntPanel.IsRunningUnix) Process.Start("nautilus", this.currentRootDir);
        return;
      }
