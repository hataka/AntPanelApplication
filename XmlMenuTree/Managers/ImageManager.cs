...
namespace AntPanelApplication.Managers
{
    static class ImageManager
    {
        ...
        static ImageManager()
        {
      double scale = 2.0;// ScaleHelper.GetScale();
            ...
            if (scale >= 1.5)
            {
                ...
                //Source = new Bitmap(Path.Combine(Application.ExecutablePath, "Images32.png"));
                Source = (Bitmap)AntPanel.fdImage32;
            }
            else
            {
                Size = Size16;
                Padding = 0;
                //Source = new Bitmap(Path.Combine(Application.ExecutablePath, "Images.png"));
                Source = (Bitmap)AntPanel.fdImage;
            }
    }
    ...
    public static Image GetComposedBitmap(string data, bool autoAdjusted)
        ...
        public static Image GetComposedBitmapSize16(string data, bool autoAdjusted)
        {
            ...
            if (!Cache.ContainsKey(key))
            {
                ...
                int size = 16;// ScaleHelper.Scale(Size16);
      ...
      */
      saturation = 0; brightness = 0; return false;
    }
