	...
	public class AboutDialog : Form
	{
	  ...
	  this.copyLabel.Text = "";// PluginCore.DistroConfig.DISTRIBUTION_ABOUT;
		...
		private void InitializeGraphics()
		{
			...
			this.imageBox.Image = Image.FromFile(Path.Combine(PathHelper.SettingDir, "AboutDialog.jpg"));
		}
	  ...
	  //String link = "https://www.github.com/fdorg/flashdevelop/commit/";// + sha;
	  String link = "https://github.com/fdorg/flashdevelop";
      ...
      if (target != null) Globals.MainForm.OpenCustomDocument("BrowserEx","https://github.com/fdorg/flashdevelop");
	  }
