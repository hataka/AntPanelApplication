...
*/
    ...
    public static string Run_Script(string path)
		...
		public static string Exec_CSharpCodeProvider01(object frm, string path)
		{
			...
			compilerParameters.ReferencedAssemblies.Add(Path.Combine(appDir, "DockableControls\\azuki.dll"));
			compilerParameters.ReferencedAssemblies.Add(Path.Combine(appDir, "DockableControls\\AzukiEditor.dll"));
			compilerParameters.ReferencedAssemblies.Add(Path.Combine(appDir, "DockableControls\\PluginCore.dll"));
			compilerParameters.ReferencedAssemblies.Add(Path.Combine(appDir, "FlashDevelop.exe"));
